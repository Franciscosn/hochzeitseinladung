...
async function openInvitation(forceMotion = true) {
  ...
  status.textContent = T.statusOpening || 'Deine Einladung wird geöffnet.';
  ...
  status.textContent = T.statusOpened || 'Francisco und Katherine heiraten am 9. Januar 2027 in Villa de Leyva, Kolumbien.';
